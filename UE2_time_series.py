...
ax1[1].plot(np.abs(fft_dataset)[0:1360], "red", label='fft data')
ax1[2].plot(y, "blue", label='filtered (Butterworth)')
ax1[3].plot(np.abs(np.fft.fft(y))[1:1360], "orange", label='fft data filtered')
...
ax1[3].set_xlim(-1,1360)
#ax1[3].set_yscale('log')
# ax1[3].tick_params(axis="y")
ax1[3].set_title("FFT Filtered Data (Butterworth)", fontsize=20)
...
ax3[1].plot(np.abs(fft_dataset[0:1360]), "red", label='fft data')
ax3[2].plot(y, "blue", label='filtered (Butterworth)')
ax3[3].plot(np.abs(np.fft.fft(y)[1:1360]), "orange", label='fft data filtered')
...
ax3[3].set_xlim(-1,1360)
#ax3[3].set_yscale('log')
ax3[3].set_title("FFT Filtered Data (Elliptic)", fontsize=20)
